// app18.js v2 — landing fixes + notifications + profile + docs + socials + featured
console.log('✝️ app18.js v2 loading...');
(function () {
  ...
  /* ══ FIX 4: SAFE save — never overwrite with null ══ */
...
console.log('✝️ app18.js v2 active');
