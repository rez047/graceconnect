...
(function () {
    ...
    // your existing app35.js code
    // ...
    
})();   // <-- EXISTING END OF APP35.JS


/* ============================================================
   GROUP MEMBERS INBOX PATCH
...
(function () {
    ...
    console.log('✉️ GraceConnect Group Members Inbox Patch loaded');
    ...
    function openMemberChat(uid) {
        ...
        /*
         * USE THE SAME EXISTING CHAT FUNCTION
         * USED BY THE REST OF GRACECONNECT.
         */
        ...
        console.warn(
            'GraceConnect: openChatWith() is not available.'
        );
    }

    function createInboxButton(uid) {
        var user = getCurrentUser();
        ...
        /*
         * SAME EXISTING CHAT BUTTON STYLE
         */
        button.className = 'btn btn-sm btn-chat';
    ...
    function getUidFromElement(row) {

        if (!row) return null;

        var value;

        value = row.getAttribute('data-user-id');

        if (value) return value;

        value = row.getAttribute('data-userid');

        if (value) return value;

        value = row.getAttribute('data-uid');

        if (value) return value;

        /*
         * Look inside child elements.
         */
        var child =
            row.querySelector(
        ...
        if (child) {
            ...
            return (
                ...
                child.getAttribute('data-userid') ||
                child.getAttribute('data-uid')
            );
        }

        /*
         * Existing onclick/onchange handlers frequently
         * contain the member UUID.
         */
        var attrs = [
            'onclick',
            'onchange'
    ...
    function addInboxToRow(row) {
        ...
        /*
         * Don't interfere with an existing working
         * Inbox/Chat button.
         */
        if (
            row.querySelector(
        ...
        var button =
            createInboxButton(uid);

        if (!button) return;

        /*
         * Try the existing action areas first.
         */
        var actions =
            row.querySelector(
                '.member-actions,' +
        ...
        /*
         * Otherwise place it at the end of the
         * member row.
         */
    ...
    function patchContainer(container) {
        ...
        /*
         * First check elements that explicitly expose
        ...
        /*
         * Fallback for the existing group/category
         * member cards.
         */
        var candidates =
            container.querySelectorAll(
    ...
    function patchAllMembers() {

        patchGroupMembers();
        patchCategoryMembers();
    }
    ...
    /*
     * Groups and categories are loaded dynamically,
     * therefore watch for DOM changes.
     */
    ...
    function initialiseGroupInbox() {
        ...
        /*
         * Allow the existing Supabase member
         * queries/rendering to finish.
         */
        setTimeout(
            schedulePatch,
            500
